...
## [3.8.4] - 2025-08-19
### Fixed
- Issue with curl not working properly on Windows systems when performing mirror URL checks

## [3.8.3] - 2025-08-19
### Fixed
- Issue when attempt to download packages from different mirrors, now properly tries next mirror if one fails
